...
export const Skills = () => {
    const skills = [
      ...
      { name: 'Vue', icon: VueIcon, bgClass: 'bg-green-400/20' },
      { name: 'Angular', icon: AngularIcon, bgClass: 'bg-red-400/20' },
      { name: 'SaSS', icon: Sass, bgClass: 'bg-pink-400/20' },
      { name: 'Tailwind CSS', icon: TailwindCSS, bgClass: 'bg-cyan-400/20' },
      { name: 'Vite', icon: ViteIcon, bgClass: 'bg-purple-500/20' },
      { name: 'NodeJS', icon: NodeJs, bgClass: 'bg-green-500/20' },
    ];
